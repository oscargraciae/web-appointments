...
var next_google_fonts_1 = __importDefault(require("next-google-fonts"));
...
var MyDocument = /** @class */ (function (_super) {
    ...
    MyDocument.prototype.render = function () {
        ...
        <document_1.Head>
          <next_google_fonts_1.default href="https://fonts.googleapis.com/css2?family=Nunito:wght@300;400;500;600;700;900&display=swap"/>
          <next_google_fonts_1.default href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;600;700;900&display=swap"/>
        </document_1.Head>
        <body>
          <document_1.Main />
