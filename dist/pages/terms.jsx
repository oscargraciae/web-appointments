    ...
    return (<Wrapper_1.Wrapper>
      <react_2.Flex justify="center" align="center" w="960px" bgSize="cover" direction='column' mx='auto'>
        ...
        <react_2.VStack alignItems='flex-start' spacing={10} mb={14}>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>Uso del Sitio.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>Su Cuenta.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>Modificaciones a las “Condiciones”.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>Ofrecimientos de Proveedores.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>Prohibiciones.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>Sistema Reputacional.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>Indemnización, Ley Aplicable y Jurisdicción.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
