...
var Privacy = function () {
    return (<Wrapper_1.Wrapper>
      <react_2.Flex justify="center" align="center" w="960px" bgSize="cover" direction='column' mx='auto'>
        <react_2.Heading w='100%' textAlign='center' pb={14} mb={14} mt={4} borderBottomWidth={1} borderColor='borders'>Política de Privacidad</react_2.Heading>
        <react_2.VStack alignItems='flex-start' spacing={10} mb={14}>
          <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>Última actualización: Febrero de 2021</react_2.Text>
          <react_2.Box>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>FINALIDADES A QUE SE SUJETARA EL TRATAMIENTO DE DATOS PERSONALES.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>Solicitudes de Consumidores.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px' mb={3}>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>OPCIONES Y MEDIOS QUE CHAMBITA LABS, S. A. P. I. de C. V., OFRECE A LOS TITULARES DE DATOS PERSONALES PARA LIMITAR EL USO O DIVULGACIÓN DE SU INFORMACIÓN.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>MEDIOS PARA EL EJERCICIO DE DERECHOS DEL TITULAR.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>TRANSFERENCIA DE DATOS PERSONALES.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
          ...
          <react_2.Box>
            <react_2.Text fontWeight='bold' mb={3} fontSize='xl'>Enlaces.</react_2.Text>
            <react_2.Text color='subtext' lineHeight='26px'>
