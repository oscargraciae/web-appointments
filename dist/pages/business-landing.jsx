...
var BusinessLanding = function (_a) {
    return (<react_2.Flex justify="center" align="center" w="100%" bgSize="cover" direction='column'>
      ...
      <Wrapper_1.Wrapper>
        ...
        <react_2.Flex direction={{ base: 'column', md: 'row' }} justifyContent='space-between' mb={20}>
          <react_2.SimpleGrid columns={2} spacing={6} ml={6} w={{ base: '91%', md: '42%' }}>
            <react_2.Box>
          ...
          <react_2.Image src='/agenda-landing.png' w='53%' display={{ base: 'none', md: 'block' }}/>
        </react_2.Flex>
