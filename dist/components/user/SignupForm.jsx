...
var signup_1 = require("../../validations/signup");
exports.SignupForm = function (_a) {
    ...
    var onSubmit = function (values) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new userService_1.UserService().signup(values)];
                case 1:
                    response = _a.sent();
                    if (response.success) {
                        reloadUser();
    ...
    return (<>
      <react_2.ModalHeader>Regístrate</react_2.ModalHeader>
        <react_2.ModalBody>
          <formik_1.Formik initialValues={initalState} onSubmit={onSubmit} validationSchema={signup_1.SignupSchemaValidation}>
          {function (_a) {
        var isSubmitting = _a.isSubmitting, errors = _a.errors, touched = _a.touched;
        return (<formik_1.Form>
            <react_2.VStack spacing={4}>
              <react_2.HStack>
                <InputField_1.InputField name='firstName' label='Nombre'/>
                <InputField_1.InputField name='lastName' label='Apellido'/>
              </react_2.HStack>
              <InputField_1.InputNumberField name='phone' label='Número telefónico'/>
              ...
              <react_2.Text mb={2}>¿Ya tienes una cuenta?{" "}
                <react_2.Link color='primary' fontWeight='bold' onClick={function () { return setTab(1); }}>Iniciar sesión</react_2.Link>
              </react_2.Text>
            </react_2.VStack>
          </formik_1.Form>);
    }}
