...
const BookingResume = ({}) => {
  ...
  return BookingResume_jsx(react_["Flex"], {
    ...
    fontWeight: "bold",
    mb: 3
  }, "Servicios a reservar"), services.map(service => BookingResume_jsx(react_["Flex"], {
    justify: "space-between"
  }, BookingResume_jsx(react_["Text"], {
    isTruncated: true,
    fontWeight: "semibold",
...
const BusinessServices = ({
  ...
  return BusinessServices_jsx(react_["Box"], null, BusinessServices_jsx(react_["Heading"], {
    ...
    borderRadius: 3,
    bg: "surface"
  }, BusinessServices_jsx(react_["Flex"], {
    ...
    w: "210px",
    pr: 3
  }, item.name), BusinessServices_jsx(react_["Box"], null, BusinessServices_jsx(react_["Text"], {
    color: "subtext",
    fontSize: "sm",
    fontWeight: "600"
  }, "$", item.price), BusinessServices_jsx(react_["Text"], {
    color: "subtext",
    fontSize: "xs",
    fontWeight: "500"
  ...
  }, BusinessServices_jsx(ti_["TiPlus"], null)))))));
};
