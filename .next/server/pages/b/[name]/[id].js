...
const getServerSideProps = async ({
  ...
  if (params !== null && params !== void 0 && params.id) {
    response = await new _services_businessService__WEBPACK_IMPORTED_MODULE_2__[/* BusinessService */ "a"]().getById(Number(params.id));
  }
...
const Business = ({
  ...
  return __jsx(_context_bookingContext__WEBPACK_IMPORTED_MODULE_6__[/* BookingProvider */ "b"], null, __jsx(_components_business_MetaBusiness__WEBPACK_IMPORTED_MODULE_11__[/* MetaBusiness */ "a"], {
    ...
    mb: 6
  }, business.cover && __jsx(_chakra_ui_react__WEBPACK_IMPORTED_MODULE_1__["Image"], {
    objectFit: "cover",
    w: "250px",
    h: "166px",
    rounded: "md",
    ...
    display: "flex",
    alignItems: "center"
  }, __jsx(react_icons_ti__WEBPACK_IMPORTED_MODULE_4__["TiLocation"], null), businessAddress === null || businessAddress === void 0 ? void 0 : businessAddress.addressMap), __jsx(_chakra_ui_react__WEBPACK_IMPORTED_MODULE_1__["Text"], {
    fontSize: "xs",
    color: "grey",
    mb: 2,
    display: "flex",
    alignItems: "center"
  }, __jsx(react_icons_ti__WEBPACK_IMPORTED_MODULE_4__["TiDevicePhone"], null), business.phone))), __jsx(_chakra_ui_react__WEBPACK_IMPORTED_MODULE_1__["Flex"], {
    mb: 10,
    direction: "row"
  }, __jsx(_chakra_ui_react__WEBPACK_IMPORTED_MODULE_1__["Box"], {
    w: "58.33%"
  }, __jsx(_chakra_ui_react__WEBPACK_IMPORTED_MODULE_1__["Box"], null, __jsx(_chakra_ui_react__WEBPACK_IMPORTED_MODULE_1__["Heading"], {
    as: "h3",
    size: "lg",
    mb: 3
  }, "Informaci\xF3n"), __jsx(_chakra_ui_react__WEBPACK_IMPORTED_MODULE_1__["Text"], {
    py: 3,
    color: "subtext"
  }, business.description)), __jsx(_chakra_ui_react__WEBPACK_IMPORTED_MODULE_1__["Divider"], {
    my: 8
