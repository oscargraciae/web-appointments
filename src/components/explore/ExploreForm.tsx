        ...
        <PlacesAutocomplete
          ...
          >
            { (({ getInputProps, suggestions, getSuggestionItemProps, loading }) => (
                <Box w="70%">
                  <Input {...getInputProps()} placeholder='Dirección ' color='primary' size='md' variant="flushed" my={4} borderBottomColor='#DDD' fontWeight='semibold' pt='3px' border='0px' _hover={{ borderBottomWidth: 4, cursor: 'pointer' }} />
